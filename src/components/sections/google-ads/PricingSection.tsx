  ...
  return (
    <section id="pricing" className="py-20 md:py-32 bg-[#141414]">
      <Container>
          ...
          {dict.packages.map((pkg) => (
            ...
            >
              ...
              <div className="mb-6">
                ...
                <p className="text-xs text-muted-foreground mt-1">{pkg.budgetInfo}</p>
              </div>
        ...
        >
          <p className="text-sm text-muted-foreground border border-border rounded-lg inline-block px-4 py-2">
            {dict.budgetNote}
          </p>
        </motion.div>
